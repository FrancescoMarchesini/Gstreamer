...
{
    // playbin uri=rtsp://root:root@192.168.1.90:554/axis-media/media.amp uridecodebin0::source::latency=100 video-sink=videoconvert ! video/x-raw,width=320,height=240 ! ximagesink
    // gst-launch-1.0 rtspsrc location=rtsp://root:root@192.168.1.90:554/axis-media/media.amp ! rtph264depay ! h264parse ! decodebin ! videoconvert ! autovideosink
    // playbin uri=rtsp://root:root@192.168.1.90:554/axis-media/media.amp uridecodebin0::source::latency=300
...
bool gstCamera::init()
{
    ...
    mPipeline = gst_parse_launch("playbin uri=rtsp://root:root@192.168.1.90:554/axis-media/media.amp uridecodebin0::source::latency=300", NULL);
